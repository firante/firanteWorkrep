    ...
    var AppComponent = React.createClass({
      ...
      render: function () {
        ...
        var itemHTML = items.map(function (listItem) {
          return React.createElement('li', { key: listItem.id }, listItem.name);
        });

        return React.createElement('div', null, React.createElement('ul', null, itemHtml), React.createElement('button', { onClick: this.createNewItem }, ' New Item '));
      }
    });
